...
int rtl8821ae_download_fw(struct ieee80211_hw *hw, bool buse_wake_on_wlan_fw)
{
	...
	if (buse_wake_on_wlan_fw) {
		...
		pfwheader = (struct rtl8821a_firmware_header *)rtlhal->p_wowlan_firmware;
				  ...
				  bool b_dl_finished, bool dl_whole_packets)
{
	...
	/*---------------------------------------------------------
				(6) Remote Wake Ctrl
	----------------------------------------------------------*/
	SET_8821AE_H2CCMD_AOAC_RSVDPAGE_LOC_REMOTE_WAKE_CTRL_INFO(u1RsvdPageLoc2, REMOTE_PG);
...
void rtl8812ae_c2h_ra_report_handler(struct ieee80211_hw *hw,
...
)
{
	...
	case C2H_8812_BT_INFO:
		...
		if (rtlpriv->cfg->ops->get_btc_status()){
			rtlpriv->btcoexist.btc_ops->btc_btinfo_notify(rtlpriv, tmp_buf, c2h_cmd_len);
		}
		break;
